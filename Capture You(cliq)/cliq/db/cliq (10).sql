...
('mano', 'mano', 'photographer', 'not approved');
...
(6, 'mano', 'hh', 'male', 'Ernakulam', 'kaloor', 'all', 'mano@gmail.com', '9563254879', 'static/MEDIA/cap%20img_BYwh06c.jpg', 'mano', 'mano', 'not approved', 'not member', 'not member');
